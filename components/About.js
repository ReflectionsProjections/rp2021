      ...
      <Row>
        ...
        >
          <AboutSection>
            ...
            <AboutSection.Body>
              Reflections|Projections is an annual technology conference held at the University of Illinois at Urbana-Champaign. We bring industry and academia into one conference to incite the spread of novel ideas, connect students with professional opportunities, and host a one of a kind AI hackathon. 
            </AboutSection.Body>
            <AboutSection.Body>
              This year, for the 27th anniversary of Reflections|Projections, the conference will be held from September 20th till 25th and will be focused on the intersection of tech and social good. Stay tuned for updates regarding our various speakers, panels, networking events, and MechMania. 
            </AboutSection.Body>

            <AboutSection.Title>Our Team</AboutSection.Title>
            <AboutSection.Body>
              We are students passionate about technology who embody the diversity and excellence inherent at the University of Illinois at Urbana-Champaign. Our staff comes from a variety of personal and professional backgrounds, and our staff comes together to plan and organize an event which reflects our dedication to exploring the field of tech. Wee can't wait for you to come to Reflections|Projections 2021! 
            </AboutSection.Body>


            <AboutSection.Title>Conference Format + COVID Guidelines</AboutSection.Title>
            <AboutSection.Body>
              In order to adhere to university safety guidelines, our conference will be held in a hybrid (in-person and virtual) format. As we approach the conference dates, we will publish the specific details of each event. Please remember that masks should be worn at all times to any in-person events, as we want to do our part in preventing the spread of the virus.
            </AboutSection.Body>
            <AboutSection.Body>
              We are excited about the opportunity to leverage this hybrid event format to make our talks and conference events more accessible to people throughout the global CS community, but also allow students who are on campus to be able to interact safely with one another. 
            </AboutSection.Body>
